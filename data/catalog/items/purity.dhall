...
in { item = { name = "Purity"
, description = "Reduce your skill cooldowns by 2 seconds. You are unlucky."
...
, advanced_description = 
    ...
    ''
, unlocked_by = Some "Complete the **The Calm** challenge. Beat the game on Monsoon difficulty"
, interactions = 
