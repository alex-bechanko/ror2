{
      ...
      "rluiten/sparsevector" = {
        sha256 = "0ic4clqrldl2y2bcmvcyq51d0fysv4szgyjws9pdh8xas3rzd4if";
        version = "1.0.3";
      };

      "rluiten/stemmer" = {
        sha256 = "1pbl88g82p0vy1xv16ypjbqm0h0xxirf0kdsbc2xjk2g2xldbri5";
        version = "1.0.4";
      };

      "rluiten/trie" = {
        sha256 = "0s6f3w63zrlgggp8i6pzkhvsz5pc3qsnd167ygnkmkshr6959gh8";
        version = "2.1.0";
      };
}
